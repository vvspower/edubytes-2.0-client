...
import { IGetUserResponse, ResponseSuggestedUser, ReturnedResource, SuggestedUser, User } from "../../ApiManager/interface/Interfaces";
...
const UserProfile = () => {
    ...
    const getUserResources = async () => {
        console.log(username, logged_user)
    ...
    return (
        <div className={styles.container}>
            <div>
                {user?.username != "" ? <EditProfileModal pfp={user?.details.pfp!} bio={user?.details.bio!} verified={user?.details.verified!} education={user?.education} open={openModal} handleClose={() => setOpenModal(false)} /> : null}
            </div>
            ...
            <div className={styles.user_header_details}>
                ...
                <main>
                    <div>
                        <img className={styles.pfp} src={user?.details.pfp} />
                    </div>
                ...
                <div className={styles.interaction_btns}>
